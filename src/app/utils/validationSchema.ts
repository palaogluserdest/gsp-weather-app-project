...
const registerValidationSchema = Yup.object({
  ...
  email: Yup.string().matches(emailRegex, 'Invalid email address').required('You must write email address'),
  password: Yup.string().min(8, 'Your password must be longer than 8 characters').required('You must enter a password'),
